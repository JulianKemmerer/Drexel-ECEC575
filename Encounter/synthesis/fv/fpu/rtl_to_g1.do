set log file fv/fpu/rtl_to_g1.log -replace
...
vpx read guide file fv/fpu/rtl_to_g1.ovf
...
write hier_compare dofile fv/fpu/hier_rtl_to_g1.do \
...
run hier_compare fv/fpu/hier_rtl_to_g1.do -analyze_abort  -dynamic_hierarchy
